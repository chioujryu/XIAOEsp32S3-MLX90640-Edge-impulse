 ...
 * @brief 兩張照片相疊
 * 
 * @param srcImage1 Input image buffer 1
 * @param proportion1 transparent scale, proportion1 and proportion2 need to be 1
 * @param srcImage2 Input image buffer 2
 * @param srcProportion2 transparent scale, proportion1 and proportion2 need to be 1
 * @param dstImage Output image buffer, can be same as input buffer 
 * @param srcWidth Input width in pixels
 * @param srcHeight Input height in pixels
 */
/*
void two_image_rgb888_addition(
    const uint8_t *srcImage1,
    float srcProportion1,
    const uint8_t *srcImage2,

...
const uint16_t CAMERA_RESIZE_FRAME_BUFFER_COLS      = 640;
const uint16_t CAMERA_RESIZE_FRAME_BUFFER_ROWS      = 480;
...
uint8_t * rgb888_buf_320x240_esp_and_mlx90640_addition = (uint8_t *) malloc(320 * 240 * 3 * sizeof(uint8_t));
...
void loop()
{
  ...
  if (takeNewPhoto) {
    captureCorrectedESP32andMLX90640PhotoAdditionSaveToSpiffs(mlx90640To, 
                                                              ...
                                                              CAMERA_RAW_FRAME_BUFFER_COLS,
                                                              CAMERA_RAW_FRAME_BUFFER_ROWS,
                                                              rgb888_buf_320x240_esp32,
                                                              rgb888_buf_640x480_esp32,
                                                              32*16,
                                                              24*16,
                                                              120,
                                                              100,
                                                              rgb888_buf_320x240_esp_and_mlx90640_addition,
                                                              SPIFFS_FILE_PHOTO);                                       
    takeNewPhoto = false;
  }
...
void captureCorrectedESP32andMLX90640PhotoAdditionSaveToSpiffs( float * thermal_buf, 
                                                                ...
                                                                uint8_t * rgb888_buf_320x240_esp32,
                                                                uint8_t * rgb888_buf_640x480_esp32,
                                                                uint16_t esp_fb_resize_width,
                                                                uint16_t esp_fb_resize_height,
                                                                uint16_t esp_fb_crop_start_x,
                                                                uint16_t esp_fb_crop_start_y,
                                                                uint8_t * rgb888_buf_320x240_esp_and_thermal_addition,
    ...
    ei::image::processing::resize_image(rgb888_buf_320x240_esp32, 
                                        esp_fb_raw_width, 
                                        esp_fb_raw_height, 
                                        rgb888_buf_640x480_esp32, 
                                        esp_fb_resize_width, 
    ...
    ei::image::processing::crop_image_rgb888_packed(rgb888_buf_640x480_esp32, 
                                                    esp_fb_resize_width, 
                                                    esp_fb_resize_height, 
                                                    esp_fb_crop_start_x, 
                                                    esp_fb_crop_start_y, 
    ...
    // rgb888 to jpg
    if( !fmt2jpg( rgb888_buf_320x240_esp_and_thermal_addition, 

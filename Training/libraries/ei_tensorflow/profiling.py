...
def make_predictions(mode, model, validation_dataset, Y_test, train_dataset,
                            Y_train, test_dataset, Y_real_test, akida_model_path, item_feature_axes: list = None):
    if akida_model_path:
    ...
    return make_predictions_tflite(mode, model, validation_dataset, Y_test,
                                   train_dataset, Y_train, test_dataset, Y_real_test, item_feature_axes)

def make_predictions_tflite(mode, model, validation_dataset, Y_test, train_dataset, Y_train, test_dataset, Y_real_test, item_feature_axes: list = None):
...
def profile_model(model_type, model, model_file, validation_dataset, Y_test, X_samples, Y_samples,
                         ...
                         akida_model_path=None, item_feature_axes: list = None):
    ...
    prediction, prediction_train, prediction_test = make_predictions(mode, model, validation_dataset, Y_test,
                                                                     ...
                                                                     Y_real_test, akida_model_path, item_feature_axes)
...
def get_model_metadata(keras_model, validation_dataset, Y_test, X_samples, Y_samples, has_samples,
    ...
    if model_float32:
        try:
            ...
            float32_perf = profile_model(model_type, model_float32, file_float32, validation_dataset, Y_test, X_samples, Y_samples, has_samples, memory, mode, prepare_model_tflite_script, prepare_model_tflite_eon_script, len(class_names), train_dataset, Y_train, test_dataset, Y_real_test, item_feature_axes=item_feature_axes)
    ...
    if model_int8:
        try:
            ...
            int8_perf = profile_model(model_type, model_int8, file_int8, validation_dataset, Y_test, X_samples, Y_samples, has_samples, memory, mode, prepare_model_tflite_script, prepare_model_tflite_eon_script, len(class_names), train_dataset, Y_train, test_dataset, Y_real_test, item_feature_axes=item_feature_axes)

...
uint8_t * rgb888_buf_320x240_1 = NULL;
uint8_t * rgb888_buf_320x240_2 = NULL;
uint8_t * rgb888_buf_320x240_3 = NULL;
...
void capture(uint8_t * rgb888_buf){
...
void loop() {
  ...
  rgb888_buf_320x240_1 = (uint8_t *)malloc(320*240*3);
  rgb888_buf_320x240_2 = (uint8_t *)malloc(320*240*3); 
  rgb888_buf_320x240_3 = (uint8_t *)malloc(320*240*3); 
  
  logMemory();

  capture(rgb888_buf_320x240_1);
  delay(100);
  capture(rgb888_buf_320x240_2);

  two_image_addition(rgb888_buf_320x240_1, 
                      0.5, 
                      rgb888_buf_320x240_2, 
                      0.5, 
                      rgb888_buf_320x240_3, 
                      320, 
                      240, 
                      3);
  
  free(rgb888_buf_320x240_1);
  free(rgb888_buf_320x240_2);
  free(rgb888_buf_320x240_3);
  
  rgb888_buf_320x240_1 = NULL;
  rgb888_buf_320x240_2 = NULL;
  rgb888_buf_320x240_3 = NULL;
